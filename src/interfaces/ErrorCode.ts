enum ErrorCode {
	...
	"400_REGISTRATION_ID_MUST_BE_TEXT" = "A matrícula deve ser do tipo texto.",
	...
	"400_FIELD_MUST_BE_TEXT" = "O campo deve ser do tipo texto.",
	"400_FIELD_IS_REQUIRED" = "Informe o campo.",
	"400_FIELD_IS_NOT_ALLOWED" = "Informe um campo válido.",
	"400_ID_MUST_BE_TEXT" = "O ID deve ser do tipo texto.",
	...
	"400_DONATION_CATEGORY_MUST_BE_TEXT" = "A categoria deve ser do tipo texto.",
	...
	"400_PARTNER_ID_MUST_BE_TEXT" = "O identificador do associado deve ser do tipo texto.",
	...
	"400_DONATION_DESCRIPTION_MUST_BE_TEXT" = "A descrição da contribuição deve ser do tipo texto.",
}
